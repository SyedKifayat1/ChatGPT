...
const Main = ({isOpen}) => {
    ...
    const { setText, text, isListening, startListening, stopListening, hasRecognitionSupport } = useSpeechRecognition();
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e) => {
        if (e.key === 'Enter' && !e.shiftKey) {
            e.preventDefault();
            onSent(); // Call your function here for handling Enter key press without Shift
    ...
    return (
        <div className='main'>
            <div className="nav">
                <div class="dropdown">
                    <a class="btn dropdown-toggle pt-2 pb-2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style={{ border: "none" }}>
                        ChatGPT
                    </a>
            ...
            <div className="main-container">
                {!showResult ? (
                    ...
                    <>
                        <div className="greet">
                            {/* <p><span>Hello, Syed Kifayat</span></p>
                        ...
                        <div className="cards">
                            <div className="card">
                                <i class="fa-solid fa-graduation-cap" style={{ color: '#7DD2EC' }}></i>

                                <p>Explain Superconductor</p>

                            </div>
                            <div className="card">
                                <i class="fa-solid fa-pen" style={{ color: 'rgb(203, 139, 208)' }}></i>
                                <p>Activities to make friends in new city</p>

                            </div>
                            <div className="card">
                                <i class="fa-regular fa-lightbulb" style={{ color: '#E2C643' }}></i>
                                <p>Experience Seoul like a local</p>

                            </div>
                            <div className="card">
                                <i class="fa-solid fa-plane-departure" style={{ color: '#E2C643' }}></i>
                ...
                {/* This div ensures auto-scrolling to the last result */}
                ...
                <div className={isOpen ? "main-bottom" : "main-bottom-offSide"}>
                    <div className="search-box">
                        ...
                        />
                        <div>
                            {input ? <img onClick={() => onSent()} src={assets.send_icon} alt="" /> : <button className="mic-btn" onClick={isListening ? stopListening : startListening}>
                                {isListening && <div className="wave"></div>}
                                <img className={isListening ? 'recording' : ''} src={assets.mic_icon} alt="" />
                            </button>}
                        </div>
                    </div>
