...
const Main = () => {
    const { onSent, prevPrompts, showResult, isOpen, loading, setInput, input } = useContext(Context);
    const [voices, setVoices] = useState([]);
    const [selectedVoice, setSelectedVoice] = useState(null);
    const [speech, setSpeech] = useState(new SpeechSynthesisUtterance());
    const { setText, text, isListening, startListening, stopListening } = useSpeechRecognition();
        ...
        <div className='main'>
            <div className="nav">
                <div className="dropdown">
                    <a className="btn dropdown-toggle pt-2 pb-2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" style={{ border: "none" }}>
                        ChatGPT
                    </a>
            ...
            <div className="main-container"ref={containerRef}>
                    ...
                    <>{
                        ...
                        {prevPrompts.length > 0 && (
                            <div className='result'>
                                ...
                                <div className="result-data">
                                    <div style={{ display: 'flex', flexDirection: "column", alignItems: 'center', gap: '10px' }}>
                                        <svg width="25" height="25" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-2/3 w-2/3" role="img">
                                    ...
                                    {prevPrompts[prevPrompts.length - 1].result === "" && loading ? (
                                        ...
                                        <div className="content-container" >
                                            <pre className="wrapped-code">
                                                <code dangerouslySetInnerHTML={{ __html: prevPrompts[prevPrompts.length - 1].result }} />
                                            </pre>
                                        </div>
                                    )}
                                </div>
                ...
                <div className={isOpen ? "main-bottom" : "main-bottom-offSide"}>
                    <div className="search-box">
                        ...
                        />
                        <div>
                            {input ? <img onClick={() => onSent(input)} src={assets.send_icon} alt="" /> : <button className="mic-btn" onClick={isListening ? stopListening : startListening}>
